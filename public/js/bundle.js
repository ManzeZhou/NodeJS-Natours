...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/manzezhou/cljnldjqa00ng01pg8zo5g73c',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your review was successfully uploaded!');
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
        ...
        case 7:
          ...
          _context.t0 = _context["catch"](0);
          console.log(_context.t0);
          (0, _alerts.showAlert)('error', 'You can only leave one review for each tour you have booked');
        case 11:
        case "end":
          return _context.stop();
      }
...
// submit review
var reviewDataForm = document.querySelector('.modal-contents');
if (reviewDataForm) {
  reviewDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var review = document.getElementById('review').value;
    var rating = Number(document.getElementById('ratings').value);
